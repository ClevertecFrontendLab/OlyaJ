export const veganRecipes = [
    ...
    },
    {
        ...
        image: '/images/juicyDishes/image5.jpg',
        bookmarks: 258,
        likes: 1342,
        ...
        steps: [
            {
                ...
                image: '/recipeImages/image1.jpg',
            },
            {
                stepNumber: 2,
                description: 'Обжарить курицу с луком и шафраном.',
                image: '/recipeImages/image2.png',
            },
            {
                stepNumber: 3,
                description: 'Смешать лапшу с курицей и подавать.',
                image: '/recipeImages/image3.jpg',
            },
        ],
    },
];

export const veganSnacks = [
    {
        id: '0',
        title: 'Картошка, тушенная с болгарским перцем и фасолью в томатном соусе',
        description:
...

    {
        ...
        steps: [
            ...
            },
            {
                ...
                title: 'Лапша с курицей и шафраном',
                description:
                    'Ароматная лапша с курицей и шафраном, идеальное сочетание для сытного обеда.',
                category: ['second-dish'],
                subcategory: ['poultry-dish'],
                image: '/images/juicyDishes/image5.jpg',
                bookmarks: 258,
...
export const allRecipes = [...veganRecipes, ...mostJuicyRecipes, ...veganSnacks];
